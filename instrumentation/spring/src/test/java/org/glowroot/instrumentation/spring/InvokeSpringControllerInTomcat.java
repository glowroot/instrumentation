...
public class InvokeSpringControllerInTomcat implements AppUnderTest {
    ...
    private void exec(String contextPath, String path, int port) throws Exception {
        AsyncHttpClient asyncHttpClient = new AsyncHttpClient();
        int statusCode = asyncHttpClient.prepareGet("http://localhost:" + port + contextPath + path)
