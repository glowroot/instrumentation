...
public class JsfRenderIT {
    ...
    public void shouldCaptureJsfRendering() throws Exception {
        ...
        assertThat(localSpan.message()).isEqualTo("jsf render: /hello.xhtml");
    ...
    public void shouldCaptureJsfAction() throws Exception {
        ...
        IncomingSpan incomingSpan =
                container.executeForTypeAndName(PostHello.class, "Web", "/hello.xhtml;xyz");
        ...
        assertThat(localSpan.message()).isEqualTo("jsf invoke: #{helloBean.hello}");
        assertThat(localSpan.childSpans()).isEmpty();
