...
public class RequestHeaderIT {
    ...
    public void testBadRequestHeaders() throws Exception {
        ...
        // when
        IncomingSpan incomingSpan = container.executeForType(GetBadRequestHeaders.class, "Web");
    ...
    public void testBadRequestHeaders2() throws Exception {
        ...
        // when
        IncomingSpan incomingSpan = container.executeForType(GetBadRequestHeaders2.class, "Web");
