...
public class AnnotatedServletIT {
    ...
    public void testServlet() throws Exception {
        // when
        IncomingSpan incomingSpan = container.executeForType(InvokeServlet.class, "Web");

        // then
        assertThat(incomingSpan.message()).isEqualTo("/hello/5");
    ...
    public void testServletWithContextPath() throws Exception {
        ...
        IncomingSpan incomingSpan =
                container.executeForType(InvokeServletWithContextPath.class, "Web");

        // then
        assertThat(incomingSpan.message()).isEqualTo("/zzz/hello/5");
