...
public class MessageTest {
    ...
    public void shouldTruncateDetail() {
        ...
        Object rawList = truncatedDetail.get("list");
        assertThat(rawList).isInstanceOf(List.class);
        List<Object> list = ImmutableList.copyOf((List<?>) rawList);
        assertThat(list).containsExactly(longString, longString + suffix,
                "x" + Strings.repeat("a", 9999) + suffix);
