...
public class Java9 {
    ...
    private final Object engineModule;
    ...
    public static void grantAccessToEngine(Instrumentation instrumentation, Object module)
            throws Exception {
        checkNotNull(instance);
        instance.grantAccessToEngineInternal(instrumentation, module);
    }
    ...
    private Java9() {
        try {
            ...
            engineModule = checkNotNull(getModuleMethod.invoke(Java9.class));
    ...
    private void grantAccessToEngineInternal(Instrumentation instrumentation, Object module)
            throws Exception {
        redefineModuleMethod.invoke(instrumentation, module, ImmutableSet.of(engineModule),
