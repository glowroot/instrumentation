 ...
 */
package org.glowroot.instrumentation.engine.weaving.other;

import org.glowroot.instrumentation.engine.weaving.targets.Misc;

// this needs to be in a package other than "org.glowroot.instrumentation.engine.weaving", since that is the
// package used when generating MethodMetaHolder classes, and so would have access to
// SomethingPrivate.class class constant
