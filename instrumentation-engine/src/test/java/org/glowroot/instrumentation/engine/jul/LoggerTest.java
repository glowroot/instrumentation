...
public class LoggerTest {
    ...
    public void testImplementsAllMethods() {
        Set<MethodSignature> shadedLoggerMethods = Sets.newHashSet();
        for (Method method : Logger.class.getMethods()) {
            ...
            for (Class<?> clazz : method.getParameterTypes()) {
                ...
                builder.addParameterTypes(parameterType
                        .replaceFirst("org.glowroot.instrumentation.engine.jul.",
                                "java.util.logging."));
            }
            shadedLoggerMethods.add(builder
        ...
        assertThat(shadedLoggerMethods).containsAll(loggerMethods);
    }
