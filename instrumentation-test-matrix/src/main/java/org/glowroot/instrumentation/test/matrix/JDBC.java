...
public class JDBC {
    ...
    private static final String hsqldbJava6Version = "2.3.6";
    ...
    static void runShort() throws Exception {
        hsqldbShort();
        h2Short();
        commonsDbcpWrappedShort();
        commonsDbcp2WrappedShort();
        tomcatWrappedShort();
        glassfishWrappedShort();
        hikariCpWrappedShort();
        bitronixWrappedShort();
    }

    static void runAll() throws Exception {
        hsqldbAll();
        h2All();
        commonsDbcpWrappedAll();
        commonsDbcp2WrappedAll();
        tomcatWrappedAll();
        glassfishWrappedAll();
        hikariCpWrappedAll();
        bitronixWrappedAll();
    ...
    private static void hsqldbShort() throws Exception {
        runHsqldb("2.0.0");
        runHsqldbJava8("2.4.0");
    }

    private static void hsqldbAll() throws Exception {
        runHsqldb("2.0.0");
        runHsqldb("2.2.4");
        for (int i = 6; i <= 9; i++) {
            runHsqldb("2.2." + i);
    ...
    private static void h2Short() throws Exception {
        runH2("1.0.20061217");
        runH2Java7("1.4.192");
    }

    private static void h2All() throws Exception {
        runH2("1.0.20061217");
        runH2("1.0.20070304");
        runH2("1.0.20070429");
        runH2("1.0.20070617");
    ...
    private static void commonsDbcpWrappedShort() throws Exception {
        runCommonsDbcpWrapped("1.3");
    }

    private static void commonsDbcpWrappedAll() throws Exception {
        runCommonsDbcpWrapped("1.3");
        runCommonsDbcpWrapped("1.4");
    }

    private static void commonsDbcp2WrappedShort() throws Exception {
        runCommonsDbcp2Wrapped("2.0");
    }

    private static void commonsDbcp2WrappedAll() throws Exception {
        runCommonsDbcp2Wrapped("2.0");
    ...
    private static void tomcatWrappedShort() throws Exception {
        runTomcatWrapped("7.0.19");
        runTomcatWrappedJava7("8.0.1");
        runTomcatWrappedJava8("9.0.1");
    }

    private static void tomcatWrappedAll() throws Exception {
        for (int i = 19; i <= 92; i++) {
    ...
    private static void glassfishWrappedShort() throws Exception {
        runGlassfishWrappedJava7("4.0");
        runGlassfishWrappedJava8("5.0");
    }

    private static void glassfishWrappedAll() throws Exception {
        runGlassfishWrappedJava7("4.0");
    ...
    private static void hikariCpWrappedShort() throws Exception {
        runHikariCp1xWrapped("1.3.4");
        runHikariCpJava6WrappedButNotJava6("2.0.0");
        runHikariCpJava8Wrapped("2.0.0");
        runHikariCpJava6Wrapped("2.0.1");
    }

    private static void hikariCpWrappedAll() throws Exception {
        for (int i = 4; i <= 9; i++) {
    ...
    private static void bitronixWrappedShort() throws Exception {
        runBitronix2xWrapped("1.2");
    }

    private static void bitronixWrappedAll() throws Exception {
        runBitronix2xWrapped("1.2");
    ...
    private static void runHsqldb(String version) throws Exception {
        ...
        Util.runTests(MODULE_PATH, "-Dtest.jdbcConnectionType=HSQLDB", JAVA8, JAVA7, JAVA6);
    }

    private static void runHsqldbJava8(String version) throws Exception {
        Util.updateLibVersion(MODULE_PATH, "hsqldb.version", version);
        Util.runTests(MODULE_PATH, "-Dtest.jdbcConnectionType=HSQLDB", JAVA8);
    }

    private static void runH2(String version) throws Exception {
        Util.updateLibVersion(MODULE_PATH, "h2.version", version);
        Util.runTests(MODULE_PATH, "-Dtest.jdbcConnectionType=H2", JAVA8, JAVA7, JAVA6);
    }

    private static void runH2Java7(String version) throws Exception {
        Util.updateLibVersion(MODULE_PATH, "h2.version", version);
        Util.runTests(MODULE_PATH, "-Dtest.jdbcConnectionType=H2", JAVA8, JAVA7);
    }
    ...
    private static void runCommonsDbcpWrapped(String version) throws Exception {
        ...
        Util.updateLibVersion(MODULE_PATH, "hsqldb.version", hsqldbJava6Version);
        Util.runTests(MODULE_PATH, "-Dtest.jdbcConnectionType=COMMONS_DBCP_WRAPPED", JAVA8, JAVA7,
                JAVA6);
    }
    ...
    private static void runCommonsDbcp2Wrapped(String version) throws Exception {
        ...
        Util.updateLibVersion(MODULE_PATH, "hsqldb.version", hsqldbJava8Version);
        Util.runTests(MODULE_PATH, "-Dtest.jdbcConnectionType=COMMONS_DBCP2_WRAPPED", JAVA8);
    }
    ...
    private static void runTomcatWrapped(String version) throws Exception {
        ...
        Util.updateLibVersion(MODULE_PATH, "hsqldb.version", hsqldbJava6Version);
        Util.runTests(MODULE_PATH, "-Dtest.jdbcConnectionType=TOMCAT_JDBC_POOL_WRAPPED", JAVA8,
                JAVA7, JAVA6);
    }
    ...
    private static void runGlassfishWrappedJava7(String version) throws Exception {
        ...
        Util.updateLibVersion(MODULE_PATH, "hsqldb.version", hsqldbJava6Version);
        Util.runTests(MODULE_PATH, "-Dtest.jdbcConnectionType=GLASSFISH_JDBC_POOL_WRAPPED", JAVA8,
                JAVA7);
    }
    ...
    private static void runHikariCp1xWrapped(String version) throws Exception {
        ...
        Util.updateLibVersion(MODULE_PATH, "hsqldb.version", hsqldbJava6Version);
        Util.runTests(MODULE_PATH, "-Dtest.jdbcConnectionType=HIKARI_CP_WRAPPED", JAVA8, JAVA7,
                JAVA6);
    }
    ...
    private static void runHikariCpJava8Wrapped(String version) throws Exception {
        ...
        Util.updateLibVersion(MODULE_PATH, "hikari.cp.version", version);
        Util.updateLibVersion(MODULE_PATH, "hsqldb.version", hsqldbJava8Version);
        Util.runTests(MODULE_PATH, "-Dtest.jdbcConnectionType=HIKARI_CP_WRAPPED", JAVA8);
    }
    ...
    private static void runBitronix2xWrapped(String version) throws Exception {
        ...
        Util.updateLibVersion(MODULE_PATH, "hsqldb.version", hsqldbJava6Version);
        Util.runTests(MODULE_PATH, "-Dtest.jdbcConnectionType=BITRONIX_WRAPPED", JAVA8, JAVA7,
                JAVA6);
    }
    ...
    private static void runBitronix3xWrapped(String version) throws Exception {
        ...
        Util.updateLibVersion(MODULE_PATH, "bitronix.cp.version", version);
        Util.updateLibVersion(MODULE_PATH, "hsqldb.version", hsqldbJava8Version);
        Util.runTests(MODULE_PATH, "-Dtest.jdbcConnectionType=BITRONIX_WRAPPED", JAVA8);
    }
}
